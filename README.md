...
```toml
theme = "graphite"   # graphite, midnight, tokyonight-night, paper, ember, catppuccin-latte, catppuccin-frappe, catppuccin-macchiato, catppuccin-mocha, zenburn, custom
...
[custom_theme]
base = "graphite"    # graphite, midnight, tokyonight-night, paper, ember, catppuccin-latte, catppuccin-frappe, catppuccin-macchiato, catppuccin-mocha, zenburn
label = "My Theme"
accent = "#7fd1ff"
panel = "#10161d"
noteBorder = "#c49bff"
